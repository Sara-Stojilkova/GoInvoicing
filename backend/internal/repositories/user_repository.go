...
type UserRepository interface {
	...
	// UpdateSignupFields sets the agency_id, email, and activated flag on a user row.
	...
	UpdateSignupFields(ctx context.Context, id uuid.UUID, agencyID uuid.UUID, email string, activated bool) error
}
